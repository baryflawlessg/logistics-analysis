#!/usr/bin/env python3
"""
Demo Script for Delivery Failure Analysis System
===============================================

This script demonstrates all 6 sample use cases with the sample data.
Run this to see the system in action and generate sample outputs.
...
def run_demo():
    ...
    print("🚚 Delivery Failure Analysis System - DEMO")
    print("=" * 50)
